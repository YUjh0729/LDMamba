...
class nnUNetTrainerAttentionUnet(nnUNetTrainerNoDeepSupervision):
    def __init__(
                self,
                plans: dict,
                configuration: str,
    ...
    def build_network_architecture(plans_manager: PlansManager,
        ...
        model = AttentionUnet(
            ...
            channels=(16, 32, 64, 128, 256),  # 每个层次的卷积核数量
            strides=(2, 2, 2, 2),  # 下采样的步长
        )

        # # print("AttentionUnet: {}".format(model))
        #
        # # ---------------------yjh----------------------
