...
nnUNet_raw = r'/mnt/e/yjh/project/LDMamba/data/nnUNet_raw' # os.environ.get('nnUNet_raw')
nnUNet_preprocessed = r'/mnt/e/yjh/project/LDMamba/data/xxx/nnUNet_preprocessed' # os.environ.get('nnUNet_preprocessed')
nnUNet_results = r'/mnt/e/yjh/project/LDMamba/data/xxx/nnUNet_results' # os.environ.get('nnUNet_results')
