...
# 计算总体的平均NSD和标准差
overall_mean_NSD = case_avg_NSD.mean()
overall_std_NSD = case_std_NSD.mean()

print(20 * '>')
print(f'Overall Average NSD for {basename(seg_path)}: {overall_mean_NSD:.4f} ± {overall_std_NSD:.4f}')
print(20 * '<')